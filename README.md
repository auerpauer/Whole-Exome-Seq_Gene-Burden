...
This program reads in variant table files, along with corresponding descriptive headers.
It writes, to stdout, a tab-delimited file that contains the number of variants for each gene in each variant file.
...
An example of a bash command line using this program follows:
...
If you wish to use these programs and have problems, I honestly suggest you read through all the documentation, both in this README and in the code files, themselves.
